...
class DeveloperQuery(BaseModel):
    desarrollador: str  # Parámetro de consulta para desarrollador.
...
# GET endpoint para recomendar juegos basados en el título
@app.get("/recommendations")
async def recommend_games_get(game_title: str):
    """
    Endpoint GET para recomendar videojuegos similares basado en el título del juego.
    """
    ...
    try:
        ...
        # Capturar errores si el juego no se encuentra
        raise HTTPException(status_code=404, detail=str(e))



# POST endpoint para recomendar juegos basados en el título enviado en el cuerpo
@app.post("/recommendations")
async def recommend_games_post(game_request: GameRequest):
    """
    Endpoint POST para recomendar videojuegos similares basado en el título enviado en el cuerpo de la solicitud.
    """
